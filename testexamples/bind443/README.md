...
whether the bind succeeded. When successful, it keeps the listener open, logs a
heartbeat every 10 seconds, and logs accepted TCP connections before closing
them.
