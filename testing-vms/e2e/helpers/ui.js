...
export async function createNixDockerDeployment(page, {
  ...
  await step(`submit deployment ${name}`, () => byTestId(dialog, 'create-deployment-submit', dialog.getByRole('button', {name: 'Create'})).click());
...
export async function upgradeOpenDeployAgents(page, {version = process.env.OPD_UPGRADE_VERSION || 'v0.0.257', workerName = 'worker-1'} = {}) {
