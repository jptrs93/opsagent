...
const BACKUP_RESTORE_DEFAULTS = {
  ...
  minioReadyURL: `http://${process.env.OPD_SECONDARY_HOST || 'opendeploy-secondary'}:9000/minio/health/ready`,
...
export async function upgradeOpenDeployAgents(page, {version = process.env.OPD_UPGRADE_VERSION || 'v0.0.256', workerName = 'worker-1'} = {}) {
