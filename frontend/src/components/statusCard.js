    ...
    return tr(
        ...
        td(
            ...
            ...scheduledInstances.map((instance, index) => {
                ...
                return div(
                    // The stage names are wider than the column, so the line is
                    // truncated rather than wrapped: wrapping would break the
                    // per-instance alignment with Status and Version.
                    {class: `${scheduledInstanceCellClass} flex items-center px-3`},
                    copy
                        ...
                        ? button({
                            ...
                            title: `${copy.text} — view prepare output`,
                            type: "button",
                        }, copy.text)
