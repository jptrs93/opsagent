...
/**
 * @param {DeploymentDef} message
 * @param {Writer} writer
 */
export function writeDeploymentDef(message, writer) {
 ...
 * @returns {Uint8Array}
 */
export function encodeDeploymentDef(message) {
    const writer = Writer.create();
    writeDeploymentDef(message, writer);
 ...
 * @param {Reader} reader
 * @param {number} [length]
 * @returns {DeploymentDef}
 */
function decodeDeploymentDefMessage(reader, length) {
 ...
 * @returns {DeploymentDef}
 */
export function decodeDeploymentDef(buffer) {
    const reader = Reader.create(new Uint8Array(buffer));
    return decodeDeploymentDefMessage(reader);
}
...
export function writeDeployment(message, writer) {
    ...
    if (message.def !== undefined && message.def !== null) {
