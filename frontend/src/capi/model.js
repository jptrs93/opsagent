 ...
 */
/**
 * @typedef {Object} DeploymentEvent
 ...
 * @property {boolean} localCaAvailable
 */
/**
...
export function writeDeployment(message, writer) {
    ...
    if (message.scheduling !== undefined && message.scheduling !== null) {
...
/**
 * @param {Scheduling} message
 * @param {Writer} writer
 */
export function writeScheduling(message, writer) {
    if (message.running === true) {
        writer.uint32(tag(1, WIRE.VARINT)).bool(message.running);
    }
    if (message.dedicatedNodes !== undefined && message.dedicatedNodes !== null) {
 ...
 * @returns {Uint8Array}
 */
export function encodeScheduling(message) {
    const writer = Writer.create();
    writeScheduling(message, writer);
    return writer.finish();
}
 ...
 * @returns {Scheduling}
 */
export function decodeScheduling(buffer) {
    const reader = Reader.create(new Uint8Array(buffer));
    return decodeSchedulingMessage(reader);
}



/**
 * @param {DedicatedNodesScheduling} message
 * @param {Writer} writer
 */
export function writeDedicatedNodesScheduling(message, writer) {
    if (message.nodes) {
 ...
 * @returns {Uint8Array}
 */
export function encodeDedicatedNodesScheduling(message) {
    const writer = Writer.create();
    writeDedicatedNodesScheduling(message, writer);
    return writer.finish();
}
 ...
 * @param {Reader} reader
 * @param {number} [length]
 * @returns {DedicatedNodesScheduling}
 */
function decodeDedicatedNodesSchedulingMessage(reader, length) {
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = {nodes: [] };
    while (reader.pos < end) {
        const tag = reader.uint32();
 ...
 * @returns {DedicatedNodesScheduling}
 */
export function decodeDedicatedNodesScheduling(buffer) {
    const reader = Reader.create(new Uint8Array(buffer));
    return decodeDedicatedNodesSchedulingMessage(reader);
}



/**
 * @param {DeploymentEvent} message
 * @param {Writer} writer
 */
export function writeDeploymentEvent(message, writer) {
    ...
    if (message.eventType !== undefined && message.eventType !== null && message.eventType !== 0) {
        writer.uint32(tag(15, WIRE.VARINT)).int32(message.eventType);
    }
    if (message.createdTime instanceof Date && message.createdTime.getTime() !== 0) {
        writer.uint32(tag(16, WIRE.VARINT)).int64(Math.trunc(message.createdTime.getTime()));
    }
    if (message.eventTime instanceof Date && message.eventTime.getTime() !== 0) {
        writer.uint32(tag(17, WIRE.VARINT)).int64(Math.trunc(message.eventTime.getTime()));
    }
    ...
    if (message.value !== undefined && message.value !== null) {
        ...
        writeDeployment(message.value, writer);
        writer.ldelim();
    }
}
 ...
 * @returns {Uint8Array}
 */
export function encodeDeploymentEvent(message) {
    const writer = Writer.create();
    writeDeploymentEvent(message, writer);
    return writer.finish();
}
...
function decodeDeploymentEventMessage(reader, length) {
    ...
    while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
            ...
            case 17: {
                message.eventTime = new Date(readInt64(reader, "int64"));
                break;
            }
            case 7: {
            ...
            case 18: {
                message.value = decodeDeploymentMessage(reader, reader.uint32());
                break;
            }
            default:
                reader.skipType(tag & 7);
 ...
 * @returns {DeploymentEvent}
 */
export function decodeDeploymentEvent(buffer) {
    const reader = Reader.create(new Uint8Array(buffer));
    return decodeDeploymentEventMessage(reader);
}
...
function decodeContainerSpecMessage(reader, length) {
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = {source: undefined, runtime: undefined, version: "", upgradeStrategy: 0, readinessSignal: undefined };
    while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
            case 1: {
...
function decodeDeploymentCreateRequestMessage(reader, length) {
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = {name: "", spaceId: 0, spec: undefined, scheduling: undefined };
    while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
            case 1: {
...
/**
 * @param {DeploymentGetResponse} message
 * @param {Writer} writer
 */
 ...
 * @returns {Uint8Array}
 */
export function encodeDeploymentGetResponse(message) {
    const writer = Writer.create();
    writeDeploymentGetResponse(message, writer);
    return writer.finish();
}
 ...
 * @returns {DeploymentGetResponse}
 */
export function decodeDeploymentGetResponse(buffer) {
    const reader = Reader.create(new Uint8Array(buffer));
    return decodeDeploymentGetResponseMessage(reader);
}
...
export function writeDeploymentRunReport(message, writer) {
    ...
    if (message.deploymentVersion !== undefined && message.deploymentVersion !== null && message.deploymentVersion !== 0) {
        writer.uint32(tag(13, WIRE.VARINT)).int32(message.deploymentVersion);
    }
}
...
function decodeDeploymentRunReportMessage(reader, length) {
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = {deploymentId: 0, deploymentSpecVersion: 0, nodeId: 0, instanceOrdinal: 0, run: 0, running: false, startedAt: new Date(0), stoppedAt: new Date(0), exitCode: undefined, logLines: [], warnings: [], status: 0, deploymentVersion: 0 };
    while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
            case 1: {
...
export function writeLogQueryRequest(message, writer) {
    ...
    if (message.deploymentVersion !== undefined && message.deploymentVersion !== null && message.deploymentVersion !== 0) {
        writer.uint32(tag(3, WIRE.VARINT)).int32(message.deploymentVersion);
    }
...
function decodeLogQueryRequestMessage(reader, length) {
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = {deploymentId: 0, targetNodeId: 0, deploymentVersion: 0, timeStart: new Date(0), timeEnd: new Date(0), filters: [], limit: 0, histogramBuckets: 0, includeRaw: false, order: "", requestId: "" };
    while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
            case 1: {
...
export function writeMetricsSample(message, writer) {
    ...
    if (message.deploymentVersion !== undefined && message.deploymentVersion !== null && message.deploymentVersion !== 0) {
        writer.uint32(tag(5, WIRE.VARINT)).int32(message.deploymentVersion);
    }
    if (message.run !== undefined && message.run !== null && message.run !== 0) {
...
function decodeMetricsQueryRequestMessage(reader, length) {
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = {deploymentId: 0, targetNodeId: 0, scheduledInstanceId: 0, deploymentVersion: 0, run: 0, timeStart: new Date(0), timeEnd: new Date(0), stepMs: 0, fields: [], requestId: "" };
    while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
            case 1: {
...
function decodeMetricsSeriesMessage(reader, length) {
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = {scheduledInstanceId: 0, ordinal: 0, deploymentVersion: 0, run: 0, nodeId: 0, field: "", kind: 0, values: [] };
    while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
            case 1: {
...
export function writeAsset(message, writer) {
    ...
    if (message.sha256 !== undefined && message.sha256 !== null && message.sha256 !== "") {
        writer.uint32(tag(3, WIRE.LDELIM)).string(message.sha256);
    }
...
export function writeAuthMethodsResponse(message, writer) {
    ...
    if (message.localCaAvailable === true) {
        writer.uint32(tag(3, WIRE.VARINT)).bool(message.localCaAvailable);
    }
}
...
function decodeAuthMethodsResponseMessage(reader, length) {
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = {passkeyLoginEnabled: false, passwordLoginEnabled: false, localCaAvailable: false };
    while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
            case 1: {
            ...
            case 3: {
                message.localCaAvailable = reader.bool();
                break;
            }
            default:
                reader.skipType(tag & 7);
...
export function writeAgentSession(message, writer) {
    if (message.userId !== undefined && message.userId !== null && message.userId !== 0) {
        writer.uint32(tag(20, WIRE.VARINT)).int32(message.userId);
    }
    if (message.id !== undefined && message.id !== null && message.id !== "") {
        writer.uint32(tag(1, WIRE.LDELIM)).string(message.id);
    }
...
/**
 * @param {NodeReported} message
 * @param {Writer} writer
 */
export function writeNodeReported(message, writer) {
    ...
    if (message.hostAddressesUnknown === true) {
        writer.uint32(tag(5, WIRE.VARINT)).bool(message.hostAddressesUnknown);
    }
}
 ...
 * @returns {Uint8Array}
 */
export function encodeNodeReported(message) {
    const writer = Writer.create();
    writeNodeReported(message, writer);
    return writer.finish();
}
 ...
 * @param {Reader} reader
 * @param {number} [length]
 * @returns {NodeReported}
 */
function decodeNodeReportedMessage(reader, length) {
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = {identifier: "", underlayAddress: "", wgPublicKey: "", hostAddresses: [], hostAddressesUnknown: false };
    while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
            case 1: {
            ...
            case 5: {
                message.hostAddressesUnknown = reader.bool();
                break;
            }
            default:
                reader.skipType(tag & 7);
 ...
 * @returns {NodeReported}
 */
export function decodeNodeReported(buffer) {
    const reader = Reader.create(new Uint8Array(buffer));
    return decodeNodeReportedMessage(reader);
}



/**
 * @param {NodeOperator} message
 * @param {Writer} writer
 */
export function writeNodeOperator(message, writer) {
    if (message.name !== undefined && message.name !== null && message.name !== "") {
        writer.uint32(tag(1, WIRE.LDELIM)).string(message.name);
    }
    if (message.roles) {
    ...
    if (message.enrolledTime !== undefined && message.enrolledTime !== null && message.enrolledTime !== 0) {
        writer.uint32(tag(4, WIRE.VARINT)).int64(message.enrolledTime);
    }
}
 ...
 * @returns {Uint8Array}
 */
export function encodeNodeOperator(message) {
    const writer = Writer.create();
    writeNodeOperator(message, writer);
    return writer.finish();
}
 ...
 * @param {Reader} reader
 * @param {number} [length]
 * @returns {NodeOperator}
 */
function decodeNodeOperatorMessage(reader, length) {
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = {name: "", roles: [], allowedSpaces: [], enrolledTime: 0 };
    while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
            case 1: {
            ...
            case 4: {
                message.enrolledTime = readInt64(reader, "int64");
                break;
            }
            default:
                reader.skipType(tag & 7);
 ...
 * @returns {NodeOperator}
 */
export function decodeNodeOperator(buffer) {
    const reader = Reader.create(new Uint8Array(buffer));
    return decodeNodeOperatorMessage(reader);
}
 ...
 * @param {Writer} writer
 */
export function writeNode(message, writer) {
    if (message.status !== undefined && message.status !== null && message.status !== 0) {
        writer.uint32(tag(1, WIRE.VARINT)).int32(message.status);
    }
    if (message.enrollmentRequestedAt !== undefined && message.enrollmentRequestedAt !== null && message.enrollmentRequestedAt !== 0) {
        writer.uint32(tag(2, WIRE.VARINT)).int64(message.enrollmentRequestedAt);
    }
    if (message.operator !== undefined && message.operator !== null) {
        writer.uint32(tag(3, WIRE.LDELIM)).fork();
        writeNodeOperator(message.operator, writer);
        writer.ldelim();
    }
 ...
 * @returns {Uint8Array}
 */
export function encodeNode(message) {
    const writer = Writer.create();
    writeNode(message, writer);
    return writer.finish();
}
...
function decodeNodeMessage(reader, length) {
    ...
    while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
            ...
            case 2: {
                message.enrollmentRequestedAt = readInt64(reader, "int64");
                break;
            }
            case 3: {
                message.operator = decodeNodeOperatorMessage(reader, reader.uint32());
                break;
            }
            case 4: {
...
/**
 * @param {NodeStatus} message
 * @param {Writer} writer
 */
export function writeNodeStatus(message, writer) {
    if (message.nodeId !== undefined && message.nodeId !== null && message.nodeId !== 0) {
        writer.uint32(tag(1, WIRE.VARINT)).int32(message.nodeId);
    }
    if (message.updatedAt !== undefined && message.updatedAt !== null) {
    ...
    if (message.isConnected === true) {
        writer.uint32(tag(3, WIRE.VARINT)).bool(message.isConnected);
    }
    if (message.lastConnectedAt instanceof Date && message.lastConnectedAt.getTime() !== 0) {
        writer.uint32(tag(4, WIRE.VARINT)).int64(Math.trunc(message.lastConnectedAt.getTime()));
    }
    if (message.remoteAddress !== undefined && message.remoteAddress !== null && message.remoteAddress !== "") {
        writer.uint32(tag(5, WIRE.LDELIM)).string(message.remoteAddress);
    }
 ...
 * @returns {Uint8Array}
 */
export function encodeNodeStatus(message) {
    const writer = Writer.create();
    writeNodeStatus(message, writer);
    return writer.finish();
}
 ...
 * @returns {NodeStatus}
 */
export function decodeNodeStatus(buffer) {
    const reader = Reader.create(new Uint8Array(buffer));
    return decodeNodeStatusMessage(reader);
}
...
/**
 * @param {SystemConfig} message
 * @param {Writer} writer
 */
export function writeSystemConfig(message, writer) {
 ...
 * @returns {Uint8Array}
 */
export function encodeSystemConfig(message) {
    const writer = Writer.create();
    writeSystemConfig(message, writer);
    return writer.finish();
}
 ...
 */
function decodeSystemConfigMessage(reader, length) {
    const end = length === undefined ? reader.len : reader.pos + length;
...
function writeTimestamp(value, writer) {
    ...
    const precise = typeof epochNanoseconds === "bigint" && Number(epochNanoseconds >= 0n ? epochNanoseconds / 1000000n : (epochNanoseconds - 999999n) / 1000000n) === ms;
    const seconds = Math.floor(ms / 1000);
    const nanos = precise ? Number(epochNanoseconds - BigInt(seconds) * 1000000000n) : Math.floor((ms - (seconds * 1000)) * 1e6);
...
function decodeTimestampMessage(reader, length) {
    ...
    // Keep protobuf precision without changing Date display/JSON behavior.
    Object.defineProperty(date, "epochNanoseconds", {value: BigInt(seconds) * 1000000000n + BigInt(nanos)});
    return date;
}
