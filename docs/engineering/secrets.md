...
the machine KEK is generated by opsagent at runtime, which fits a direct
...
```
OPSAGENT_SECRETS_MACHINE_KEY = file | tpm2 | auto    (default: file)
```
...
update changes the PCRs and breaks unseal until re-sealed. opsagent's threat
