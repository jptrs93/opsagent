...
func seedDeployment(t *testing.T, store *PrimaryStorage, name string) *apigen.DeploymentConfig {
	t.Helper()
...
func writeRunnerStatus(t *testing.T, store *PrimaryStorage, instanceID int32, status apigen.RunningStatus) {
	t.Helper()
