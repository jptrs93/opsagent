...
func (s *PrimaryStorage) valueSiblingNameTakenLocked(ctx context.Context, q *Queries, spaceID, directoryID int64, name string, excludeSecretID, excludeConfigID int64) bool {
