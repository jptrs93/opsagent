...
func (s *Storage) ListConfigMetas() []*apigen.ConfigMeta {
...
func (s *Storage) GetConfigMeta(configID int32) (*apigen.ConfigMeta, bool) {
	ctx := context.Background()
...
func (s *Storage) CreateConfigWithVersion(name string, spaceID, createdBy int32, value string) (*apigen.ConfigMeta, error) {
...
// row atomically.
func (s *Storage) AppendConfigVersionWithDeploymentUpdates(configID int32, value string, updatedBy int32, updateDeployments bool, expected []storage.DeploymentConfigVersion) (*apigen.ConfigMeta, []int32, error) {
	ctx := context.Background()
...
func (s *Storage) SetConfigByName(name, value string, updatedBy int32) *apigen.ConfigMeta {
...
func (s *Storage) RenameConfig(configID int32, newName string) (*apigen.ConfigMeta, error) {
...
func (s *Storage) DeleteConfig(configID int32) (*apigen.ConfigMeta, bool) {
	s.Mu.Lock()
	defer s.Mu.Unlock()
	meta, ok := s.GetConfigMeta(configID)
	if !ok {
...
func (s *Storage) ConfigVersionIDs(configID int32) []int32 {
...
func (s *Storage) GetConfigVersionByID(id int32) (ConfigVersionRef, bool) {
...
func (s *Storage) ResolveConfig(id int32) (string, bool) {
...
func (s *Storage) ResolveConfigs(ids []int32) (map[int32]string, error) {
