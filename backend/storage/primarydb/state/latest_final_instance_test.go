...
func TestNewInstanceEvictsTheRetainedRun(t *testing.T) {
	...
	newer := store.CreateScheduledInstanceForTest(cfg.ID, cfg.SpecVersion, cfg.NodeID, 0, apigen.ScheduledInstanceTarget_SCHEDULED_INSTANCE_TARGET_RUN_SERVING)
...
func TestRetainedRunIsPerOrdinal(t *testing.T) {
	...
	first := store.CreateScheduledInstanceForTest(cfg.ID, cfg.SpecVersion, cfg.NodeID, 0, apigen.ScheduledInstanceTarget_SCHEDULED_INSTANCE_TARGET_RUN_SERVING)
	second := store.CreateScheduledInstanceForTest(cfg.ID, cfg.SpecVersion, cfg.NodeID, 1, apigen.ScheduledInstanceTarget_SCHEDULED_INSTANCE_TARGET_RUN_SERVING)
...
func TestDisplaySnapshotAppliesPredicate(t *testing.T) {
	...
	shownInst := store.CreateScheduledInstanceForTest(visible.ID, visible.SpecVersion, visible.NodeID, 0, apigen.ScheduledInstanceTarget_SCHEDULED_INSTANCE_TARGET_RUN_SERVING)
	hiddenInst := store.CreateScheduledInstanceForTest(hidden.ID, hidden.SpecVersion, hidden.NodeID, 0, apigen.ScheduledInstanceTarget_SCHEDULED_INSTANCE_TARGET_RUN_SERVING)
