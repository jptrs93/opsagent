...
func (s *Storage) GetUnfinishedAssetMigration() (AssetMigration, bool) {
...
func (s *Storage) StartAssetMigration(id int64) AssetMigration {
...
func (s *Storage) RecordAssetMigrationError(id int64, migrationErr error) AssetMigration {
...
func (s *Storage) FinishAssetMigration(id int64) AssetMigration {
...
func (s *Storage) FetchOpenDeployConfigByID(id int64) (SystemConfigRevision, error) {
...
func (s *Storage) AppendOpenDeploySettingsWithAssetMigration(blob []byte, createMigration bool) (int64, *AssetMigration, error) {
