...
func seedDeployment(t *testing.T, store *Storage, name string) *apigen.DeploymentConfig {
	t.Helper()
...
func writeRunnerStatus(t *testing.T, store *Storage, instanceID int32, status apigen.RunningStatus) {
	t.Helper()
