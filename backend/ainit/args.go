...
Usage:
  %[1]s primary
  %[1]s secondary
  %[1]s install primary [--version vX.Y.Z|latest] [--http-only true] [--web-listen :8080] [--web-tls-self-managed true] [--web-tls-cert-pem-file cert.pem] [--acme-hosts host1,host2] [--primary-name primary] [--dry-run]
