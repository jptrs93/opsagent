...
func applyEnvOverrides(content []byte, opts installOptions) []byte {
	...
	return applyEnvValues(content, values, []string{"OPENDEPLOY_INITIAL_ACME_HOSTS", "OPENDEPLOY_INITIAL_WEB_HTTP_ENABLED", "OPENDEPLOY_INITIAL_WEB_HTTP_LISTEN", "OPENDEPLOY_INITIAL_WEB_HTTPS_ENABLED", "OPENDEPLOY_INITIAL_WEB_HTTPS_LISTEN", "OPENDEPLOY_INITIAL_CLUSTER_LISTEN", "OPENDEPLOY_INITIAL_ENROLLMENT_LISTEN", "OPENDEPLOY_PRIMARY_CLUSTER_ADDR", "OPENDEPLOY_PRIMARY_ENROLLMENT_ADDR", "OPENDEPLOY_PRIMARY_ENROLLMENT_FINGERPRINT", "OPENDEPLOY_PRIMARY_NAME"})
}
