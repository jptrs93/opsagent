...
func (g *GitManager) newGithubRequest(ctx context.Context, apiURL string) (*http.Request, error) {
...
func (g *GitManager) fetchDefaultBranch(ctx context.Context, ownerRepo string) string {
