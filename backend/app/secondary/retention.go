...
func runRuntimeInputRetention(ctx context.Context, store *sqlite.SecondaryStorage, inputs *runtimeinputs.RuntimeInputs, predicate storage.ScheduledInstancePredicate) {
	for {
...
func sweepRuntimeInputs(ctx context.Context, store *sqlite.SecondaryStorage, inputs *runtimeinputs.RuntimeInputs, predicate storage.ScheduledInstancePredicate) {
